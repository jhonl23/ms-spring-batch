package com.intercorp.msspringbatch.kafka.producer;
...
@Component
public class EventMsTwoProducer {
    ...
    public ListenableFuture<SendResult<String, String>> sendMessage(Root root) throws JsonProcessingException {
        ...
        listenableFuture.addCallback(new ListenableFutureCallback<SendResult<String, String>>() {
            ...
            public void onSuccess(SendResult<String, String> result) {
                ...
                try {
                    ...
                    System.out.println("SUCCESS SEND MESSAGE MS-BATCH TO MS-TWO...");
